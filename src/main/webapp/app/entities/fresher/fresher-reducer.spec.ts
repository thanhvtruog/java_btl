...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './fresher.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRESHER_LIST actions', async () => {
    ...
    it('dispatches FETCH_FRESHER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FRESHER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FRESHER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FRESHER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FRESHER actions', async () => {
      const expectedActions = [
        {
